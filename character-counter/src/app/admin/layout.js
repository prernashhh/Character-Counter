    ...
    <html lang="en">
      ...
      {showMobileMenu && (
        <>
          ...
          />
          <aside className="fixed left-0 top-0 h-full w-72 bg-white shadow-2xl z-50 lg:hidden overflow-y-auto">
            <div className="h-full flex flex-col">
              <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <img src="/Charater Count Favicon Logo.png" alt="Character Count Online Tool logo" className="w-6 h-6" />
